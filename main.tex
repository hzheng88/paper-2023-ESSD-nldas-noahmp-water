...
the volumetric water content ($w_{i}$) shown in equation~\eqref{eq:soil-vmc}
...
The BATS runoff scheme parameterizes surface runoff ($R_{srf}$) as a funciton of
soil wetness \citep{yang1996GPC}:
\begin{align}
