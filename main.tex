...
is the fractional frozen area of the $i^{\mathrm{th}}$ soil layer
(m$^2$\,m$^{-2}$). Its parameterization is introduced by \citet{niu2006JH}:
\begin{equation}
...
grid cell follow the exponential distribution, NOAHR derives the formulas of the
soil infiltration as follows:
\begin{align}
...
kg\,m$^{-2}$\,s$^{-1}$):
\begin{equation}
    K_{\Delta t} = \frac{{K}_{\Delta t, ref}}{k_{ref}} k_{sat,1} \text{,}
\end{equation}
